...
async def load(db: AsyncSession):
    async with db.begin():
        ...
        organizations = [
            ...
            OrganizationORM(
                name="Пекарня 'Хлеб и Соль'", building=buildings[0], activities=[food]
            ),
            OrganizationORM(
                name="Суши-бар 'Суши Мания'", building=buildings[0], activities=[sushi]
            ),
            OrganizationORM(
            ...
            OrganizationORM(
                name="Бистро 'Скороход'",
                building=buildings[1],
                activities=[meat, dairy],
            ),
            OrganizationORM(
                name="Фастфуд 'Горячие Бургеры'",
                building=buildings[2],
                activities=[meat],
            ),
            OrganizationORM(
                name="Салон 'Элегантные Авто'",
                building=buildings[3],
                activities=[cars_light],
            ),
            OrganizationORM(
                name="Автосервис 'ТехноАвто'", building=buildings[3], activities=[parts]
            ),
            OrganizationORM(
                name="Кафе 'Уютный Уголок'", building=buildings[4], activities=[food]
            ),
        ]
